...
function updateCart() {
    ...
    const totalPrice = cartItems.length == 0 ? 0 :
        cartItems
        ...
        cartItemsList.innerHTML += `
            <div class="order-item col-sm-6">
                ...
                <div class="quantity-controls">
                    <button class="subtract" onclick="substractQty(${item.id})">-</button>
    ...
    balanceStatusElement.innerHTML = totalPrice > uang ? "Saldo tidak mencukupi!!!":"Lanjut ke pembayaran -->"
    balanceStatusElement.innerHTML = totalPrice == 0 ? "Pesen dulu cuy!":"Lanjut ke pembayaran -->"
}
